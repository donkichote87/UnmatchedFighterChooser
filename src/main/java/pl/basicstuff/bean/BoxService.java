...
public class BoxService {
    ...
    public BoxService() {
        ...
        games.add(new Box(8L,"Hell's Kitchen (2021)",List.of("Daredevil", "Elektra", "Bullseye")));
        games.add(new Box(9L,"For King and Country (2021)",List.of("Black Widow", "Black Panther", "Winter Soldier")));
        games.add(new Box(10L,"Battle of Legends, Volume Two (2022)",List.of("Sun Wukong", "Yennenga", "Achilles", "Bloody Mary")));
        games.add(new Box(11L,"Redemption Row (2021)",List.of("Luke Cage", "Ghost Rider", "Moon Knight")));
        games.add(new Box(12L,"Teen Spirit (2021)",List.of("Ms. Marvel", "Squirrel Girl", "Cloak and Dagger")));
        games.add(new Box(13L,"Jurassic Park - Dr. Sattler vs. T. Rex (2021)",List.of("Dr. Sattler", "T.Rex")));
    }
